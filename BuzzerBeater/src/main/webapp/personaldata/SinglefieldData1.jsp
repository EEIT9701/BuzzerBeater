...
//	List<PersonalDataVO> list=playerSvc.findByGameIDAndTeamID(4001, 3002);
									...
									<td>${singlefieldVO.twoPointShot}</td>
										...
										<%-- <c:forEach var="personalDataVO" items="${list1}">
											<tr align='center' valign='middle'>
												...
												<td><a
													href="<%=request.getContextPath()%>/players/playerInformation.jsp?playerID=${personalDataVO.playersVO.playerID}">${personalDataVO.playersVO.playerName}</a></td>
												<td><c:if
												...
												<td><fmt:formatNumber type="number"
														value="${personalDataVO.gameTime/personalDataVO.gameID}"
