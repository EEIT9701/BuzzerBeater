					...
					<div class="col-md-12">
						...
						<div class="col-md-4">
							<form method="post"
								...
								<input type="hidden" name="teamBadge"
									value="${teamsVO.teamBadge}"> <input type="hidden"
									name="teamName" value="${teamsVO.teamName}"> <input
									type="hidden" name="captainEmail"
									value="${teamsVO.captainEmail}"> <input type="hidden"
									name="captainPhone" value="${teamsVO.captainPhone}"> <input
									type="hidden" name="coachName" value="${teamsVO.coachName}">
								<input type="hidden" name="bossName" value="${teamsVO.bossName}">
								<input type="hidden" name="totalWin" value="${teamsVO.totalWin}">
								<input type="hidden" name="totalLose"
									value="${teamsVO.totalLose}"> <input type="hidden"
									name="winRate" value="${teamsVO.winRate}"> <input
									type="hidden" name="remarks" value="${teamsVO.remarks}">
							</form>
						</div>
						<div class="col-md-4"></div>
					</div>
									...
									<c:forEach var="gamesVO" items="${gamesVO}">
										<tr align='center' valign='middle'>
											...
											<td><fmt:formatDate type="both" dateStyle="short"
													timeStyle="short" value="${gamesVO.gameBeginDate}" />
											</td>
											...
											<td><c:if
													...
													test="${teamsVO.teamID == gamesVO.teamBVO.teamID}">
