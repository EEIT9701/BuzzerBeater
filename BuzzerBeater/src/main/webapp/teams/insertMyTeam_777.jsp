						...
						function loadTable() {
							...
							if (step == 1) {
								...
								$.getJSON('<%=request.getContextPath()%>/Teams.do', {
									...
									tab.append(tb);
									var cell15=$('<div class="col-md-4"><button id="prevBtn">上一步</button></div>')
									var cell16=$('<div class="col-md-4"></div>');
									var cell17=$('<div class="col-md-4"><button id="nextBtn">下一步</button></div>')
									btns.append([cell15,cell16,cell17]);
									prevBtn();
									nextBtn();
...
// 							    console.log(dt.getSeconds());
								...
								var cell15=$('<div class="col-md-4"><button id="prevBtn">上一步</button></div>')
								var cell16=$('<div class="col-md-4"></div>');
								var row_tbody=$('<tr></tr>').append([cell8, cell9, cell10, cell11, cell12, cell13, cell14]);
